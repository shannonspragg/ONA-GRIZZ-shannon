...
plot.roc(bears_presence_ps, post.int.only$fitted.values, percent=TRUE, col='#4daf4a', lwd=4, print.auc=TRUE, add=TRUE, print.auc.y=60)
...
# Save this as data:
saveRDS(kfold.10.ps, file = "post_pa_kfold10.rds")
