...
dist2pa.rast.general.1k <- rast("/Users/shannonspragg/ONA_GRIZZ/Predictor Rasters/1k_ha_dist2pa_raster.tif" )
...
conf.stack <- c(dist2pa.rast.general.1k, dist2met.rast, tot.farms.rast, tot.farms.sq.rast, hm.dens.rast, ccs.varint.rast, cattle.ranching.rast, fruit.tree.nut.rast, other.animal.rast, other.crop.rast, veg.melon.rast)
...
p_conf_rast <- -3.3 + ccs.varint.rast + (-1.4 * dist2pa.rast.general.1k) + (-1.3 * dist2met.rast) + (-0.3 * tot.farms.rast) +  (0.5 * tot.farms.sq.rast) + (0.7 * hm.dens.rast) + (-0.3 * cattle.ranching.rast) + (1.1 * fruit.tree.nut.rast) + (1.6 * other.animal.rast) + (1.6 * other.crop.rast) + (0.2 * veg.melon.rast)
