...
cattle.ranching.rast.sc <- scale2sd.raster(cattle.ranching.rast)
fruit.tree.nut.rast.sc <- scale2sd.raster(fruit.tree.nut.rast)
other.animal.rast.sc <- scale2sd.raster(other.animal.rast)
other.crop.rast.sc <- scale2sd.raster(other.crop.rast)
veg.melon.rast.sc <- scale2sd.raster(veg.melon.rast)


# We can also do this Step by Step:

# Distance to PA:
d2pa.mean <- global(dist2pa.rast.general.1k, "mean")
d2pa.sub.mean <- dist2pa.rast.general.1k - d2pa.mean[,1]
d2pa.sd <- global(d2pa.sub.mean, "sd")
d2pa.rast.sc <- d2pa.sub.mean / ( 2 * d2pa.sd[,1])
...
conf.rast.stack <- c(dist2pa.rast.sc, dist2metro.rast.sc, tot.farms.rast.sc, tot.farms.sq.rast.sc, hm.dens.rast.sc, ccs.varint.rast, cattle.ranching.rast.sc, fruit.tree.nut.rast.sc, other.animal.rast.sc, other.crop.rast.sc, veg.melon.rast.sc)
...
conflict_rast <- -3.2624640 + ccs.varint.rast + (-1.3887130 * dist2pa.rast.sc) + (-1.2986664 * dist2metro.rast.sc) + (-0.2535196 * tot.farms.rast.sc) + (0.4583006 * tot.farms.sq.rast.sc) + (0.7262155 * hm.dens.rast.sc) + (-0.2987515 * cattle.ranching.rast.sc) + (1.1384551 * fruit.tree.nut.rast.sc) + (1.5483847 * other.animal.rast.sc) + (1.6437851 * other.crop.rast.sc) #+ (0.2613143 * veg.melon.rast.sc)
