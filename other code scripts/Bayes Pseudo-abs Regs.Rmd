...
# Our bear warp data: 
warp.soi <- st_read("/Users/shannonspragg/ONA_GRIZZ/Data/processed/warp.final.shp")
```
...
dist.2.grizzpop.ps <- scale2sd(warp.pres.abs$dst__GP)
grizzinc.ps <- scale2sd(warp.pres.abs$GrizzInc)
bhs.ps <- scale2sd(warp.pres.abs$BHS)
biophys.ps <- scale2sd(warp.pres.abs$Biophys)
