...
dom.farms.rast <- terra::rast(farm.type.rast, "/Users/shannonspragg/ONA_GRIZZ/Predictor Rasters/dom_farm_type_raster.tif")

# Total Farm Count by CCS Region:
tot.farms.rast <- terra::rast(farm.count.rast, "/Users/shannonspragg/ONA_GRIZZ/Predictor Rasters/total_farm_count_raster.tif" )

# Distance to Neartest Protected Area (km):
dist2PA.rast <- terra::writeRaster(pa.soi.rast, "/Users/shannonspragg/ONA_GRIZZ/Predictor Rasters/dist2PA_raster.tif")

# Distance to Nearest Metro Area (km):
dist2met.rast <- terra::writeRaster(metro.soi.rast, "/Users/shannonspragg/ONA_GRIZZ/Predictor Rasters/dist2metro_raster.tif" )
...
# CCS Region ID:
ccs.postmeans.rast <- terra::rast(ccs.post.means.rast, "/Users/shannonspragg/ONA_GRIZZ/Predictor Rasters/CCS_postmeans_raster.tif" )
