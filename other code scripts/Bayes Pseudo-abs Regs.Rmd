...
post.pa.full <- stan_glmer(conflict_presence_ps ~ dist.2.pa.ps + dist.2.met.ps + animal.farm.dens.ps + pop.dens + (1 | CCSNAME.ps), 
                            data = mini.warp.df.ps,
                            family = binomial(link = "logit"), # define our binomial glm
...
terra::writeRaster(p_conf_rast, "/Users/shannonspragg/ONA_GRIZZ/Data/processed/prob_general_conf.tif")
