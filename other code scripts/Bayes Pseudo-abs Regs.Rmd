...
plot_model(post.pa.full, type = "pred", terms = c("b2pa.dist.ps", "b2met.dist.ps", "pop.dens", "dom.farms.ps"))
...
conflict_rast <- -2.9425813 + ccs.varint.rast + (-0.1797018 * dist2pa.rast.sc) + (-1.0084639 * dist2metro.rast.sc) + (0.1002309 * tot.farms.rast.sc) + (0.3080237 * tot.farms.sq.rast.sc) + (0.6594957 * hm.dens.rast.sc) + (-0.4220399 * cattle.ranching.rast) + (0.9789048 * fruit.tree.nut.rast) + (1.4487436 * other.animal.rast) + (1.1891119 * other.crop.rast) + (0.3190336 * veg.mel.rast)
